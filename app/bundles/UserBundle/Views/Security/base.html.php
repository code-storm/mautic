            ...
            <div class="col-lg-4 col-lg-offset-4">
                <div class="panel" name="form-login">
                    <div class="panel-body">
                        <div class="mautic-logo img-circle mb-md text-center" style="width:auto;">
<img src="<?php echo $view['assets']->getUrl('media/images/logo.png') ?>" alt="smallworld logo" height="50px">                        </div>
