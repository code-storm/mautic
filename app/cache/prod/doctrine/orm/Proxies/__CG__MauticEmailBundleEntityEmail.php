...
class Email extends \Mautic\EmailBundle\Entity\Email implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'id', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'name', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'description', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'subject', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'fromAddress', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'fromName', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'replyToAddress', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'bccAddress', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'template', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'content', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'plainText', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'customHtml', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'emailType', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'readCount', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'sentCount', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'revision', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'category', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'lists', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'stats', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'variantSentCount', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'variantReadCount', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'unsubscribeForm', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'assetAttachments', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'sessionId', 'changes', 'new', 'deletedId', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'variantChildren', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'variantParent', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'variantSettings', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'variantStartDate', 'languageSlug', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'translationChildren', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'translationParent', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'language', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'defaultDynamicContent', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Email' . "\0" . 'dynamicContent');
        }
