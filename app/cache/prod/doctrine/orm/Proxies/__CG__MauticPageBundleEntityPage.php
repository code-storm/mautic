...
class Page extends \Mautic\PageBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'title', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'alias', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'template', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'customHtml', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'content', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'hits', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'uniqueHits', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'variantHits', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'revision', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'metaDescription', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'redirectType', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'redirectUrl', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'category', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'sessionId', 'changes', 'new', 'deletedId', 'languageSlug', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'translationChildren', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'translationParent', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'language', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'variantChildren', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'variantParent', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'variantSettings', '' . "\0" . 'Mautic\\PageBundle\\Entity\\Page' . "\0" . 'variantStartDate');
        }
