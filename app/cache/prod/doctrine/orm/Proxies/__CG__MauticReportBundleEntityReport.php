...
class Report extends \Mautic\ReportBundle\Entity\Report implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'id', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'name', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'description', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'system', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'source', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'columns', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'filters', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'tableOrder', '' . "\0" . 'Mautic\\ReportBundle\\Entity\\Report' . "\0" . 'graphs', 'changes', 'new', 'deletedId');
        }
