...
$catalogue = new MessageCatalogue('en_US', array (
  ...
  array (
    ...
    'mautic.lead.lead.help.searchcommands' => '<strong>Search commands</strong><br />is:anonymous<br />is:unowned<br />is:mine<br />email:*<br />segment:{segment_alias}<br />name:*<br />company:*<br />owner:*<br />ip:*<br />ids:ID1,ID2 (comma separated IDs, no spaces)<br />common:{segment_alias} + {segment_alias} + ...<br />tag:*',
    ...
    'mautic.lead.timeline.hit_type' => 'Hit Type',
    ...
    'mautic.integration.form.field_match_notes' => 'If the values are empty for the contact, a value of \'Unknown\' will be sent. If the integration field is a pick list, be sure the list values of Mautic\'s field matches those of the integration.',
    ...
    'mautic.plugin.command.fetch.pushing.leads.events_executed' => 'Number of contacts pushed: %updated% updated and %created% created',
